...
You can also run the application using [Docker](https://www.docker.com) `docker run --name discounts-service -p 5000:5000 --network dshop-network devmentors/dshop.services.discounts` (include `-d` to run the container in the background).
